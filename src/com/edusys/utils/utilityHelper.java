 ...
 public static String getRank(double diem) {
    ...
    public static boolean checkMaNV(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            MsgBox.alert(txt.getRootPane(),"MaNV phải có 1-15 kí tự\nchữ hoa, thường không dấu hoặc số.");
            return false;
        }
    }
    ...
    public static boolean checkMaNH(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "MaNH phải có đúng 7 kí tự\nchữ thường, chữ hoa hoặc số");
            return false;
        }
    }
    ...
    public static boolean checkMaCD(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Ma CD phải có đúng 5 kí tự\nchữ thường, chữ hoa hoặc số");
            return false;
        }
    }
    ...
    public static boolean checkPass(JPasswordField txt) {
        ...
        if (txt.getPassword().length > 2 && txt.getPassword().length < 17) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Pass phải có từ 3-16 kí tự.");
            return false;
        }
    }
...
//        }
    ...
    public static boolean checkName(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Tên phải là tên tiếng việt hoặc không đấu\ntừ 3-25 kí tự");
            return false;
        }
    }
    ...
    public static boolean checkTenCD(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Tên CD phải từ 3-50 kí tự.");
            return false;
        }
    }
    ...
    public static boolean checkMoTaCD(JTextArea txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(),  "Mô tả phải từ 3-255 kí tự.");
            return false;
        }
    }
    ...
    public static boolean checkSDT(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "SĐT phải gồm 10 số\nđúng các đầu số của nhà mạng.");
            return false;
        }
    }
    ...
    public static boolean checkThoiLuong(JTextField txt) {
        ...
        try {
            ...
            if (hour >= 0) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane(),  "Thời lượng phải lớn hơn bằng 0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Thời lượng phải là số .");
            return false;
        }
    }
    ...
    public static boolean checkHocPhi(JTextField txt) {
        ...
        try {
            ...
            if (hp >= 0) {
                ...
                txt.setBackground(pink);
                MsgBox.alert(txt.getRootPane(), "Học phí phải là lớn hơn bằng 0.");
                return false;
            }
        } catch (NumberFormatException e) {
            txt.setBackground(pink);
    ...
    public static boolean checkDiem(JTextField txt) {
        ...
        try {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(),  "Điểm phải là số thực.");
            return false;
        }
    }
    ...
    public static boolean checkNullText(JTextArea txt) {
     ...
     public static boolean checkNullHoTen(JTextField txt) {
        txt.setBackground(white);
        if (txt.getText().trim().length() > 0) {
            return true;
        } else {
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), "Không được để trống họ tên ");
            return false;
        }
    }
